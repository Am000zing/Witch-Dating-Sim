label day3Solis:
    ...
    k "Cloying Crumble?"
    k "How curious..."
    k "That's an *interesting* choice for the centerpiece of the banquet, Summer."

    "Summer squeezes her hands into ambitious fists."
    s "One thing you should know about us Solis witches, Professor Circe..."
    s "... Is that we're always up for a challenge!"
    k "Oh, my!"
    ...
    k "I believe this book contains the recipe you seek."
    s "Thank you, Professor!"
    k "Do be careful, it's a complicated dish."
    ...
    "WARNING TO THE CHEF: Harvest the honeycomb within the hour of the harvest."
    ...
    s "I'm going to go look for it. I'm sure I left it around here."
    ...
    menu:
        "Lift the lid from the crate to get a good look inside to investigate.":
            ...
            s "And it looks like they've taken fondly to you."
        ...
        "Don some gardening gloves, open the lid, and feel around the inside of the box.":
            ...
            s "The bees will think they're being attacked by a non-living entity and retaliate."
            "I take my gloves off and peer back into the crate."
            "The once flashing red lights dissolve into gentle, blue lights."
            s "Perfect! Looks like they're calm now."
